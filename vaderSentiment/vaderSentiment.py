...
class SentimentIntensityAnalyzer(object):
    ...
    def sentiment_valence(self, valence, sentitext, item, i, sentiments):
        ...
        if item_lowercase in self.lexicon:
            ...
            if item_lowercase == "nicht" and i != len(words_and_emoticons)-1 and words_and_emoticons[i + 1].lower() in self.lexicon:
                # don't use valence of "no" as a lexicon item. Instead set it's valence to 0.0 and negate the next item
                valence = 0.0
            if (i > 0 and words_and_emoticons[i - 1].lower() == "nicht") \
               or (i > 1 and words_and_emoticons[i - 2].lower() == "nicht") \
               or (i > 2 and words_and_emoticons[i - 3].lower() == "nicht" and words_and_emoticons[i - 1].lower() in ["oder", "nicht"] ):
    ...
    def _least_check(self, valence, words_and_emoticons, i):
        ...
        if i > 1 and words_and_emoticons[i - 1].lower() not in self.lexicon \
                and words_and_emoticons[i - 1].lower() == "zumindest" or words_and_emoticons[i - 1].lower() == "wenigstens" :
            if words_and_emoticons[i - 2].lower() != "at" and words_and_emoticons[i - 2].lower() != "sehr":
                valence = valence * N_SCALAR
        elif i > 0 and words_and_emoticons[i - 1].lower() not in self.lexicon \
                and words_and_emoticons[i - 1].lower() == "zumindest" or words_and_emoticons[i - 1].lower() == "zumindest" :
            valence = valence * N_SCALAR
        return valence
    ...
    def _negation_check(valence, words_and_emoticons, start_i, i):
        ...
        if start_i == 0:
            if negated([words_and_emoticons_lower[i - (start_i + 1)]]):  # 1 word preceding lexicon word (w/o stopwords)
                valence = valence * N_SCALAR
        if start_i == 1:
            if words_and_emoticons_lower[i - 2] == "nicht" and \
                    (words_and_emoticons_lower[i - 1] == "so" or
                     words_and_emoticons_lower[i - 1] == "dass"):
                ...
                valence = valence * N_SCALAR
        if start_i == 2:
            if words_and_emoticons_lower[i - 3] == "nicht" and \
                    (words_and_emoticons_lower[i - 2] == "so" or words_and_emoticons_lower[i - 2] == "dass") or \
                    (words_and_emoticons_lower[i - 1] == "so" or words_and_emoticons_lower[i - 1] == "dass"):
                valence = valence * 1.25
            elif words_and_emoticons_lower[i - 3] == "ohne" and \
                    (words_and_emoticons_lower[i - 2] == "zweifel" or words_and_emoticons_lower[i - 1] == "zweifel"):
                valence = valence
